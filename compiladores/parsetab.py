...
_lr_productions = [
  ...
  ('DEF_TIPOS -> TIPO DEF_TIPOS','DEF_TIPOS',2,'p_def_tipos','sintatico.py',28),
  ('DEF_TIPOS -> <empty>','DEF_TIPOS',0,'p_def_tipos','sintatico.py',29),
  ('DEF_VAR -> VARIAVEL DEF_VAR','DEF_VAR',2,'p_def_var','sintatico.py',37),
  ('DEF_VAR -> <empty>','DEF_VAR',0,'p_def_var','sintatico.py',38),
  ('DEF_ROTINA -> ROTINA DEF_ROTINA','DEF_ROTINA',2,'p_def_rotina','sintatico.py',46),
  ('DEF_ROTINA -> <empty>','DEF_ROTINA',0,'p_def_rotina','sintatico.py',47),
  ...
  ('VARIAVEL -> VAR CAMPO ;','VARIAVEL',3,'p_variavel','sintatico.py',69),
  ('LISTA_ID -> , ID LISTA_ID','LISTA_ID',3,'p_lista_id','sintatico.py',73),
  ('LISTA_ID -> <empty>','LISTA_ID',0,'p_lista_id','sintatico.py',74),
  ('CAMPOS -> CAMPO LISTA_CAMPOS','CAMPOS',2,'p_campos','sintatico.py',81),
  ('CAMPO -> ID LISTA_ID : TIPO_DADO','CAMPO',4,'p_campo','sintatico.py',86),
  ('LISTA_CAMPOS -> ; CAMPO LISTA_CAMPOS','LISTA_CAMPOS',3,'p_lista_campos','sintatico.py',90),
  ('LISTA_CAMPOS -> <empty>','LISTA_CAMPOS',0,'p_lista_campos','sintatico.py',91),
  ('TIPO_DADO -> INTEGER','TIPO_DADO',1,'p_tipo_dado','sintatico.py',99),
  ('TIPO_DADO -> REAL','TIPO_DADO',1,'p_tipo_dado','sintatico.py',100),
  ('TIPO_DADO -> CHAR','TIPO_DADO',1,'p_tipo_dado','sintatico.py',101),
  ('TIPO_DADO -> BOOLEAN','TIPO_DADO',1,'p_tipo_dado','sintatico.py',102),
  ('TIPO_DADO -> ARRAY [ NUMERO ] OF TIPO_DADO','TIPO_DADO',6,'p_tipo_dado','sintatico.py',103),
  ('TIPO_DADO -> RECORD CAMPOS END','TIPO_DADO',3,'p_tipo_dado','sintatico.py',104),
  ('TIPO_DADO -> ID','TIPO_DADO',1,'p_tipo_dado','sintatico.py',105),
  ('ROTINA -> FUNCTION ID PARAM_ROTINA : TIPO_DADO BLOCO_ROTINA','ROTINA',6,'p_rotina','sintatico.py',116),
  ('ROTINA -> PROCEDURE ID PARAM_ROTINA BLOCO_ROTINA','ROTINA',4,'p_rotina','sintatico.py',117),
  ('PARAM_ROTINA -> ( CAMPOS )','PARAM_ROTINA',3,'p_param_rotina','sintatico.py',124),
  ('PARAM_ROTINA -> <empty>','PARAM_ROTINA',0,'p_param_rotina','sintatico.py',125),
  ('BLOCO_ROTINA -> DEF_VAR BLOCO','BLOCO_ROTINA',2,'p_bloco_rotina','sintatico.py',132),
  ('LISTA_COM -> ; COMANDO LISTA_COM','LISTA_COM',3,'p_lista_com','sintatico.py',136),
  ('LISTA_COM -> <empty>','LISTA_COM',0,'p_lista_com','sintatico.py',137),
  ('BLOCO_COM -> BLOCO','BLOCO_COM',1,'p_bloco_com','sintatico.py',144),
  ('BLOCO_COM -> COMANDO','BLOCO_COM',1,'p_bloco_com','sintatico.py',145),
  ('COMANDO -> ID NOME ATRIBUICAO','COMANDO',3,'p_comando','sintatico.py',148),
  ('COMANDO -> WHILE EXP_COM DO BLOCO_COM','COMANDO',4,'p_comando','sintatico.py',149),
  ('COMANDO -> IF EXP_COM THEN BLOCO_COM ALTERNATIVA_ELSE','COMANDO',5,'p_comando','sintatico.py',150),
  ('COMANDO -> FOR FOR_COMANDO DO BLOCO_COM','COMANDO',4,'p_comando','sintatico.py',151),
  ('COMANDO -> WRITE CONST_VALOR','COMANDO',2,'p_comando','sintatico.py',152),
  ('COMANDO -> READ ID NOME','COMANDO',3,'p_comando','sintatico.py',153),
  ('FOR_COMANDO -> ID ATRIBUICAO PARAMETRO TO PARAMETRO','FOR_COMANDO',5,'p_for_comando','sintatico.py',168),
  ('ALTERNATIVA_ELSE -> ELSE BLOCO_COM','ALTERNATIVA_ELSE',2,'p_alternativa_else','sintatico.py',172),
  ('ALTERNATIVA_ELSE -> <empty>','ALTERNATIVA_ELSE',0,'p_alternativa_else','sintatico.py',173),
  ('ATRIBUICAO -> ATRIBUICAO_SIMBOLO EXP','ATRIBUICAO',2,'p_atribuicao','sintatico.py',180),
  ('LISTA_PARAM -> PARAMETRO , LISTA_PARAM','LISTA_PARAM',3,'p_lista_param','sintatico.py',184),
  ('LISTA_PARAM -> PARAMETRO','LISTA_PARAM',1,'p_lista_param','sintatico.py',185),
  ('LISTA_PARAM -> <empty>','LISTA_PARAM',0,'p_lista_param','sintatico.py',186),
  ('EXP -> PARAMETRO EXP_L1','EXP',2,'p_exp','sintatico.py',195),
  ('EXP -> ( PARAMETRO EXP_L2','EXP',3,'p_exp','sintatico.py',196),
  ('EXP_L1 -> OP_MAT EXP','EXP_L1',2,'p_exp_l1','sintatico.py',205),
  ('EXP_L1 -> PARAM_LOGICO EXP_LOGICA','EXP_L1',2,'p_exp_l1','sintatico.py',206),
  ('EXP_L1 -> <empty>','EXP_L1',0,'p_exp_l1','sintatico.py',207),
  ('EXP_LOGICA -> OP_LOGICO EXP','EXP_LOGICA',2,'p_exp_logica','sintatico.py',218),
  ('EXP_LOGICA -> <empty>','EXP_LOGICA',0,'p_exp_logica','sintatico.py',219),
  ('PARAM_LOGICO -> OP_COMP PARAMETRO','PARAM_LOGICO',2,'p_param_logico','sintatico.py',227),
  ('PARAM_LOGICO -> <empty>','PARAM_LOGICO',0,'p_param_logico','sintatico.py',228),
  ('EXP_L2 -> OP_MAT EXP )','EXP_L2',3,'p_exp_l2','sintatico.py',236),
  ('EXP_L2 -> PARAM_LOGICO OP_LOGICO EXP )','EXP_L2',4,'p_exp_l2','sintatico.py',237),
  ('EXP_CONST -> PARAMETRO EXP_CONST_L','EXP_CONST',2,'p_exp_const','sintatico.py',245),
  ('EXP_CONST -> ( PARAMETRO OP_MAT EXP_CONST )','EXP_CONST',5,'p_exp_const','sintatico.py',246),
  ('EXP_CONST_L -> OP_MAT EXP_CONST','EXP_CONST_L',2,'p_exp_const_l','sintatico.py',253),
  ('EXP_CONST_L -> <empty>','EXP_CONST_L',0,'p_exp_const_l','sintatico.py',254),
  ('EXP_COM -> PARAMETRO PARAM_LOGICO EXP_COM_L','EXP_COM',3,'p_exp_com','sintatico.py',261),
  ('EXP_COM -> ( PARAMETRO PARAM_LOGICO OP_LOGICO EXP_COM )','EXP_COM',6,'p_exp_com','sintatico.py',262),
  ('EXP_COM_L -> OP_LOGICO EXP_COM','EXP_COM_L',2,'p_exp_com_l','sintatico.py',269),
  ('EXP_COM_L -> <empty>','EXP_COM_L',0,'p_exp_com_l','sintatico.py',270),
  ('PARAMETRO -> ID NOME','PARAMETRO',2,'p_parametro','sintatico.py',277),
  ('PARAMETRO -> NUMERO','PARAMETRO',1,'p_parametro','sintatico.py',278),
  ('PARAMETRO -> FALSE','PARAMETRO',1,'p_parametro','sintatico.py',279),
  ('PARAMETRO -> TRUE','PARAMETRO',1,'p_parametro','sintatico.py',280),
  ('OP_LOGICO -> AND','OP_LOGICO',1,'p_op_logico','sintatico.py',288),
  ('OP_LOGICO -> OR','OP_LOGICO',1,'p_op_logico','sintatico.py',289),
  ('OP_COMP -> >','OP_COMP',1,'p_op_comp','sintatico.py',293),
  ('OP_COMP -> <','OP_COMP',1,'p_op_comp','sintatico.py',294),
  ('OP_COMP -> COMPARACAO','OP_COMP',1,'p_op_comp','sintatico.py',295),
  ('OP_MAT -> +','OP_MAT',1,'p_op_mat','sintatico.py',299),
  ('OP_MAT -> -','OP_MAT',1,'p_op_mat','sintatico.py',300),
  ('OP_MAT -> *','OP_MAT',1,'p_op_mat','sintatico.py',301),
  ('OP_MAT -> /','OP_MAT',1,'p_op_mat','sintatico.py',302),
  ('NOME -> . ID NOME','NOME',3,'p_nome','sintatico.py',306),
  ('NOME -> [ PARAMETRO ]','NOME',3,'p_nome','sintatico.py',307),
  ('NOME -> ( LISTA_PARAM )','NOME',3,'p_nome','sintatico.py',308),
  ('NOME -> <empty>','NOME',0,'p_nome','sintatico.py',309),
]
