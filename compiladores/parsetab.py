...
_lr_productions = [
  ...
  ('CONSTANTE -> CONST ID = CONST_VALOR ;','CONSTANTE',5,'p_constante','sintatico.py',54),
  ('CONST_VALOR -> PALAVRA','CONST_VALOR',1,'p_const_valor','sintatico.py',58),
  ('CONST_VALOR -> EXP_CONST','CONST_VALOR',1,'p_const_valor','sintatico.py',59),
  ('TIPO -> TYPE ID = TIPO_DADO ;','TIPO',5,'p_tipo','sintatico.py',63),
  ('VARIAVEL -> VAR CAMPO ;','VARIAVEL',3,'p_variavel','sintatico.py',67),
  ('LISTA_ID -> , ID LISTA_ID','LISTA_ID',3,'p_lista_id','sintatico.py',71),
  ('LISTA_ID -> <empty>','LISTA_ID',0,'p_lista_id','sintatico.py',72),
  ('CAMPOS -> CAMPO LISTA_CAMPOS','CAMPOS',2,'p_campos','sintatico.py',79),
  ...
  ('TIPO_DADO -> INTEGER','TIPO_DADO',1,'p_tipo_dado','sintatico.py',97),
  ('TIPO_DADO -> REAL','TIPO_DADO',1,'p_tipo_dado','sintatico.py',98),
  ('TIPO_DADO -> CHAR','TIPO_DADO',1,'p_tipo_dado','sintatico.py',99),
  ('TIPO_DADO -> BOOLEAN','TIPO_DADO',1,'p_tipo_dado','sintatico.py',100),
  ('TIPO_DADO -> ARRAY [ NUMERO ] OF TIPO_DADO','TIPO_DADO',6,'p_tipo_dado','sintatico.py',101),
  ('TIPO_DADO -> RECORD CAMPOS END','TIPO_DADO',3,'p_tipo_dado','sintatico.py',102),
  ('TIPO_DADO -> ID','TIPO_DADO',1,'p_tipo_dado','sintatico.py',103),
  ('ROTINA -> FUNCTION ID PARAM_ROTINA : TIPO_DADO BLOCO_ROTINA','ROTINA',6,'p_rotina','sintatico.py',114),
  ('ROTINA -> PROCEDURE ID PARAM_ROTINA BLOCO_ROTINA','ROTINA',4,'p_rotina','sintatico.py',115),
  ('PARAM_ROTINA -> ( CAMPOS )','PARAM_ROTINA',3,'p_param_rotina','sintatico.py',122),
  ('PARAM_ROTINA -> <empty>','PARAM_ROTINA',0,'p_param_rotina','sintatico.py',123),
  ('BLOCO_ROTINA -> DEF_VAR BLOCO','BLOCO_ROTINA',2,'p_bloco_rotina','sintatico.py',130),
  ('LISTA_COM -> ; COMANDO LISTA_COM','LISTA_COM',3,'p_lista_com','sintatico.py',134),
  ('LISTA_COM -> <empty>','LISTA_COM',0,'p_lista_com','sintatico.py',135),
  ('BLOCO_COM -> BLOCO','BLOCO_COM',1,'p_bloco_com','sintatico.py',142),
  ('BLOCO_COM -> COMANDO','BLOCO_COM',1,'p_bloco_com','sintatico.py',143),
  ...
  ('FOR_COMANDO -> ID ATRIBUICAO PARAMETRO TO PARAMETRO','FOR_COMANDO',5,'p_for_comando','sintatico.py',166),
  ...
  ('ATRIBUICAO -> ATRIBUICAO_SIMBOLO EXP','ATRIBUICAO',2,'p_atribuicao','sintatico.py',179),
  ('LISTA_PARAM -> PARAMETRO , LISTA_PARAM','LISTA_PARAM',3,'p_lista_param','sintatico.py',183),
  ('LISTA_PARAM -> PARAMETRO','LISTA_PARAM',1,'p_lista_param','sintatico.py',184),
  ('LISTA_PARAM -> <empty>','LISTA_PARAM',0,'p_lista_param','sintatico.py',185),
  ('EXP -> PARAMETRO EXP_L1','EXP',2,'p_exp','sintatico.py',194),
  ('EXP -> ( PARAMETRO EXP_L2','EXP',3,'p_exp','sintatico.py',195),
  ('EXP_L1 -> OP_MAT EXP','EXP_L1',2,'p_exp_l1','sintatico.py',204),
  ('EXP_L1 -> PARAM_LOGICO EXP_LOGICA','EXP_L1',2,'p_exp_l1','sintatico.py',205),
  ('EXP_L1 -> <empty>','EXP_L1',0,'p_exp_l1','sintatico.py',206),
  ('EXP_LOGICA -> OP_LOGICO EXP','EXP_LOGICA',2,'p_exp_logica','sintatico.py',214),
  ('EXP_LOGICA -> <empty>','EXP_LOGICA',0,'p_exp_logica','sintatico.py',215),
  ('PARAM_LOGICO -> OP_COMP PARAMETRO','PARAM_LOGICO',2,'p_param_logico','sintatico.py',223),
  ('PARAM_LOGICO -> <empty>','PARAM_LOGICO',0,'p_param_logico','sintatico.py',224),
  ('EXP_L2 -> OP_MAT EXP )','EXP_L2',3,'p_exp_l2','sintatico.py',232),
  ('EXP_L2 -> PARAM_LOGICO OP_LOGICO EXP )','EXP_L2',4,'p_exp_l2','sintatico.py',233),
  ('EXP_CONST -> PARAMETRO EXP_CONST_L','EXP_CONST',2,'p_exp_const','sintatico.py',241),
  ('EXP_CONST -> ( PARAMETRO OP_MAT EXP_CONST )','EXP_CONST',5,'p_exp_const','sintatico.py',242),
  ('EXP_CONST_L -> OP_MAT EXP_CONST','EXP_CONST_L',2,'p_exp_const_l','sintatico.py',249),
  ('EXP_CONST_L -> <empty>','EXP_CONST_L',0,'p_exp_const_l','sintatico.py',250),
  ('EXP_COM -> PARAMETRO PARAM_LOGICO EXP_COM_L','EXP_COM',3,'p_exp_com','sintatico.py',257),
  ('EXP_COM -> ( PARAMETRO PARAM_LOGICO OP_LOGICO EXP_COM )','EXP_COM',6,'p_exp_com','sintatico.py',258),
  ('EXP_COM_L -> OP_LOGICO EXP_COM','EXP_COM_L',2,'p_exp_com_l','sintatico.py',265),
  ('EXP_COM_L -> <empty>','EXP_COM_L',0,'p_exp_com_l','sintatico.py',266),
  ('PARAMETRO -> ID NOME','PARAMETRO',2,'p_parametro','sintatico.py',273),
  ('PARAMETRO -> NUMERO','PARAMETRO',1,'p_parametro','sintatico.py',274),
  ('PARAMETRO -> FALSE','PARAMETRO',1,'p_parametro','sintatico.py',275),
  ('PARAMETRO -> TRUE','PARAMETRO',1,'p_parametro','sintatico.py',276),
  ('OP_LOGICO -> AND','OP_LOGICO',1,'p_op_logico','sintatico.py',284),
  ('OP_LOGICO -> OR','OP_LOGICO',1,'p_op_logico','sintatico.py',285),
  ('OP_COMP -> >','OP_COMP',1,'p_op_comp','sintatico.py',289),
  ('OP_COMP -> <','OP_COMP',1,'p_op_comp','sintatico.py',290),
  ('OP_COMP -> COMPARACAO','OP_COMP',1,'p_op_comp','sintatico.py',291),
  ('OP_MAT -> +','OP_MAT',1,'p_op_mat','sintatico.py',295),
  ('OP_MAT -> -','OP_MAT',1,'p_op_mat','sintatico.py',296),
  ('OP_MAT -> *','OP_MAT',1,'p_op_mat','sintatico.py',297),
  ('OP_MAT -> /','OP_MAT',1,'p_op_mat','sintatico.py',298),
  ('NOME -> . ID NOME','NOME',3,'p_nome','sintatico.py',302),
  ('NOME -> [ PARAMETRO ]','NOME',3,'p_nome','sintatico.py',303),
  ('NOME -> ( LISTA_PARAM )','NOME',3,'p_nome','sintatico.py',304),
  ('NOME -> <empty>','NOME',0,'p_nome','sintatico.py',305),
]
